...
de três. Os prefixos devem ser `Qtd. `, `Potência (kW) ` e `Sobrecarga `, e o
modelo extraído dos três títulos precisa ser idêntico. O formato anterior com
três linhas de cabeçalho não é aceito.
